...
Extension API v3 (current) enables extension developers to write **custom handlers for keywords**.
...
![Message flow diagram](https://imgur.com/FrgFj2C.png)
...
{/* TODO: consider using mermaid plugin https://github.com/linbudu599/rspress-plugins/tree/main/packages/rspress-plugin-mermaid */}
